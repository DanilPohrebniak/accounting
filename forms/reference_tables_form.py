...
# Form implementation generated from reading ui file 'D:\Python\PyQt\accounting\design\reference_tables_form.ui'
#
...
"}")
        ...
        self.horizontalGroupBox1.setMinimumSize(QtCore.QSize(50, 50))
        ...
        self.add = QtWidgets.QPushButton(self.horizontalGroupBox1)
        ...
        self.delete_2 = QtWidgets.QPushButton(self.horizontalGroupBox1)
        font = QtGui.QFont()
        font.setFamily("Century Gothic")
        font.setPointSize(12)
        self.delete_2.setFont(font)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("D:\\Python\\PyQt\\accounting\\design\\icons/delete.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.delete_2.setIcon(icon2)
        self.delete_2.setIconSize(QtCore.QSize(32, 32))
        self.delete_2.setObjectName("delete_2")
        self.gridLayout_10.addWidget(self.delete_2, 0, 1, 1, 1)
        self.gridLayout_9.addWidget(self.horizontalGroupBox1, 1, 0, 1, 1)
        ...
        self.reference_tables = QtWidgets.QTableWidget(self.verticalGroupBox)
        self.reference_tables.setMinimumSize(QtCore.QSize(0, 600))
        font = QtGui.QFont()
        font.setFamily("Century Gothic")
        font.setPointSize(14)
        self.reference_tables.setFont(font)
        self.reference_tables.setStyleSheet("QHeaderView::section {\n"
...
"}")
        self.reference_tables.setObjectName("reference_tables")
        self.reference_tables.setColumnCount(2)
        self.reference_tables.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.reference_tables.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.reference_tables.setHorizontalHeaderItem(1, item)
        self.reference_tables.horizontalHeader().setDefaultSectionSize(180)
        self.reference_tables.horizontalHeader().setStretchLastSection(True)
        self.reference_tables.verticalHeader().setVisible(False)
        self.gridLayout_11.addWidget(self.reference_tables, 0, 0, 1, 1)
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        item = self.reference_tables.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "Id"))
        item = self.reference_tables.horizontalHeaderItem(1)
