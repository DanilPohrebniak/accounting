...
# Form implementation generated from reading ui file 'D:\Python\PyQt\accounting\design\documents_form.ui'
#
...
"}")
        ...
        self.button_box = QtWidgets.QGroupBox(self.items_in_body)
        self.button_box.setMinimumSize(QtCore.QSize(50, 50))
        self.button_box.setMaximumSize(QtCore.QSize(500, 100))
        self.button_box.setObjectName("button_box")
        self.gridLayout_10 = QtWidgets.QGridLayout(self.button_box)
        self.gridLayout_10.setObjectName("gridLayout_10")
        self.add = QtWidgets.QPushButton(self.button_box)
        self.add.setMaximumSize(QtCore.QSize(80, 50))
        font = QtGui.QFont()
        font.setFamily("Century Gothic")
        font.setPointSize(12)
        self.add.setFont(font)
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("D:\\Python\\PyQt\\accounting\\design\\icons/add.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.add.setIcon(icon1)
        self.add.setIconSize(QtCore.QSize(32, 32))
        self.add.setObjectName("add")
        self.gridLayout_10.addWidget(self.add, 0, 0, 1, 1)
        self.settings = QtWidgets.QPushButton(self.button_box)
        font = QtGui.QFont()
        font.setFamily("Century Gothic")
        font.setPointSize(12)
        self.settings.setFont(font)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("D:\\Python\\PyQt\\accounting\\design\\icons/settings.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.settings.setIcon(icon2)
        self.settings.setIconSize(QtCore.QSize(32, 32))
        self.settings.setObjectName("settings")
        self.gridLayout_10.addWidget(self.settings, 0, 1, 1, 1)
        ...
        self.documents = QtWidgets.QTableWidget(self.verticalGroupBox)
        self.documents.setMinimumSize(QtCore.QSize(0, 600))
        self.documents.setStyleSheet("QHeaderView::section {\n"
...
"}")
        ...
        self.documents.setColumnCount(5)
        self.documents.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.documents.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.documents.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.documents.setHorizontalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.documents.setHorizontalHeaderItem(3, item)
        item = QtWidgets.QTableWidgetItem()
        self.documents.setHorizontalHeaderItem(4, item)
        self.documents.horizontalHeader().setDefaultSectionSize(180)
        ...
        self.gridLayout_9.addWidget(self.verticalGroupBox, 2, 0, 1, 1)
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        item = self.documents.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "Date"))
        item = self.documents.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "Number"))
        item = self.documents.horizontalHeaderItem(2)
        item.setText(_translate("MainWindow", "Сounterparty"))
        item = self.documents.horizontalHeaderItem(3)
        item.setText(_translate("MainWindow", "Warehouse"))
        item = self.documents.horizontalHeaderItem(4)
