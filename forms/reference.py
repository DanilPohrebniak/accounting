...
# Form implementation generated from reading ui file 'D:\Python\PyQt\accounting\design\reference.ui'
#
...
"}")
        ...
        self.goods_nav_2 = QtWidgets.QFrame(self.verticalGroupBox)
        self.goods_nav_2.setMaximumSize(QtCore.QSize(16777215, 50))
        self.goods_nav_2.setObjectName("goods_nav_2")
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(self.goods_nav_2)
        self.horizontalLayout_2.setSpacing(1)
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.goods_pic = QtWidgets.QLabel(self.goods_nav_2)
        self.goods_pic.setMaximumSize(QtCore.QSize(55, 32))
        self.goods_pic.setText("")
        self.goods_pic.setPixmap(QtGui.QPixmap("D:\\Python\\PyQt\\accounting\\design\\icons/boxes.png"))
        self.goods_pic.setObjectName("goods_pic")
        self.horizontalLayout_2.addWidget(self.goods_pic)
        self.goods = QtWidgets.QPushButton(self.goods_nav_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.goods.sizePolicy().hasHeightForWidth())
        self.goods.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setFamily("Century Gothic")
        font.setPointSize(14)
        self.goods.setFont(font)
        self.goods.setObjectName("goods")
        self.horizontalLayout_2.addWidget(self.goods)
        self.label_4 = QtWidgets.QLabel(self.goods_nav_2)
        self.label_4.setText("")
        self.label_4.setObjectName("label_4")
        self.horizontalLayout_2.addWidget(self.label_4)
        self.gridLayout_11.addWidget(self.goods_nav_2, 1, 0, 1, 1)
        ...
        self.counterparty_nav_2 = QtWidgets.QFrame(self.verticalGroupBox)
        self.counterparty_nav_2.setMaximumSize(QtCore.QSize(16777215, 50))
        self.counterparty_nav_2.setObjectName("counterparty_nav_2")
        self.counterparty_nav = QtWidgets.QHBoxLayout(self.counterparty_nav_2)
        self.counterparty_nav.setSpacing(1)
        self.counterparty_nav.setObjectName("counterparty_nav")
        self.counterparty_pic = QtWidgets.QLabel(self.counterparty_nav_2)
        self.counterparty_pic.setMaximumSize(QtCore.QSize(55, 32))
        self.counterparty_pic.setText("")
        self.counterparty_pic.setPixmap(QtGui.QPixmap("D:\\Python\\PyQt\\accounting\\design\\icons/people.png"))
        self.counterparty_pic.setObjectName("counterparty_pic")
        self.counterparty_nav.addWidget(self.counterparty_pic)
        self.counterparty = QtWidgets.QPushButton(self.counterparty_nav_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.counterparty.sizePolicy().hasHeightForWidth())
        self.counterparty.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setFamily("Century Gothic")
        font.setPointSize(14)
        self.counterparty.setFont(font)
        self.counterparty.setObjectName("counterparty")
        self.counterparty_nav.addWidget(self.counterparty)
        self.label_5 = QtWidgets.QLabel(self.counterparty_nav_2)
        self.label_5.setText("")
        self.label_5.setObjectName("label_5")
        self.counterparty_nav.addWidget(self.label_5)
        self.gridLayout_11.addWidget(self.counterparty_nav_2, 2, 0, 1, 1)
        self.warehouse_nav_2 = QtWidgets.QFrame(self.verticalGroupBox)
        self.warehouse_nav_2.setMaximumSize(QtCore.QSize(16777215, 50))
        self.warehouse_nav_2.setObjectName("warehouse_nav_2")
        self.warehouse_nav = QtWidgets.QHBoxLayout(self.warehouse_nav_2)
        self.warehouse_nav.setSpacing(1)
        self.warehouse_nav.setObjectName("warehouse_nav")
        self.warehouse_pic = QtWidgets.QLabel(self.warehouse_nav_2)
        self.warehouse_pic.setMaximumSize(QtCore.QSize(55, 32))
        self.warehouse_pic.setText("")
        self.warehouse_pic.setPixmap(QtGui.QPixmap("D:\\Python\\PyQt\\accounting\\design\\icons/warehouse.png"))
        self.warehouse_pic.setObjectName("warehouse_pic")
        self.warehouse_nav.addWidget(self.warehouse_pic)
        self.warehouse = QtWidgets.QPushButton(self.warehouse_nav_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.warehouse.sizePolicy().hasHeightForWidth())
        self.warehouse.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setFamily("Century Gothic")
        font.setPointSize(14)
        self.warehouse.setFont(font)
        self.warehouse.setObjectName("warehouse")
        self.warehouse_nav.addWidget(self.warehouse)
        self.label_6 = QtWidgets.QLabel(self.warehouse_nav_2)
        self.label_6.setText("")
        self.label_6.setObjectName("label_6")
        self.warehouse_nav.addWidget(self.label_6)
        self.gridLayout_11.addWidget(self.warehouse_nav_2, 3, 0, 1, 1)
        self.units_nav = QtWidgets.QFrame(self.verticalGroupBox)
        self.units_nav.setMaximumSize(QtCore.QSize(16777215, 50))
        self.units_nav.setObjectName("units_nav")
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout(self.units_nav)
        self.horizontalLayout_3.setSpacing(1)
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.units_pic = QtWidgets.QLabel(self.units_nav)
        self.units_pic.setMaximumSize(QtCore.QSize(55, 32))
        self.units_pic.setText("")
        self.units_pic.setPixmap(QtGui.QPixmap("D:\\Python\\PyQt\\accounting\\design\\icons/weight.png"))
        self.units_pic.setObjectName("units_pic")
        self.horizontalLayout_3.addWidget(self.units_pic)
        self.units = QtWidgets.QPushButton(self.units_nav)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.label_7 = QtWidgets.QLabel(self.units_nav)
        self.label_7.setText("")
        self.label_7.setObjectName("label_7")
        self.horizontalLayout_3.addWidget(self.label_7)
        self.gridLayout_11.addWidget(self.units_nav, 4, 0, 1, 1)
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.goods.setText(_translate("MainWindow", "Goods"))
        self.counterparty.setText(_translate("MainWindow", "Counterparty"))
        self.warehouse.setText(_translate("MainWindow", "Warehouse"))
        self.units.setText(_translate("MainWindow", "Units of measurement"))
